...
opt.conceallevel = 0
opt.cursorline = true
opt.cursorlineopt = "both"  -- Highlight both line number and full line
...
opt.showtabline = 2
opt.sidescrolloff = 8
opt.signcolumn = "yes:1"  -- Show sign column for git diffs only
opt.smartcase = true
...
opt.ttimeout = true
opt.ttimeoutlen = 50
opt.timeoutlen = 300  -- Faster key combination timeout
opt.ttyfast = true
opt.undodir = undo_dir
opt.undofile = true
opt.undolevels = 10000
opt.undoreload = 10000
opt.updatetime = 250  -- Faster CursorHold events for better responsiveness
opt.wildmenu = true
